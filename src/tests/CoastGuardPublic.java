...
public class CoastGuardPublic {
  ...
  public void testa0() throws Exception {
    ...
    assertTrue(
      "The output actions do not lead to a goal state.",
  ...
  public void testb0() throws Exception {
    String solution = CoastGuard.solve(grid0, "DF", true);
    solution = solution.replace(" ", "");
    assertTrue(
      "The output actions do not lead to a goal state.",
      applyPlan(grid0, solution)
  ...
  public static boolean applyPlan(String grid, String solution) {
    ...
    Checker s = new Checker(m, n, x, x00, x01, xyz, m4,m5);
